<template>
  <el-container style="height: 100vh; border: 1px solid #eee">
    <el-aside width="200px" style="height:100vh;background-color:#545c64;overflow:hidden;">
      <el-menu
        router
      ...
      >
        ...
        <el-submenu index="3">
          <template slot="title">
            <i class="el-icon-s-ticket"></i>运营管理
          </template>
          <el-menu-item-group>
    ...
    <el-container text-color="#fff">
      ...
      <el-main>
        <div v-if="$route.name=='Main'" class="mainPic">
          <div class="cube">
            <div class="img1"></div>
            <div class="img2"></div>
            <div class="img3"></div>
